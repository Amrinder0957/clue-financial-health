...
def explain_risk(
    ...
    if risk_id == "CF-001":
        ...
        if severity == "CRITICAL":
            explanation = (
                ...
                "Current cash reserves may be depleted within 15 days "
                "at recent spending rates."
            )
        else:
            explanation = (
                f"Your estimated cash runway is {runway:.1f} days "
    ...
    elif risk_id in ("ANOMALY-001", "ANOMALY_001"):
    ...
    elif risk_id in ("ANOMALY-002", "ANOMALY_002"):
    ...
    elif risk_id in ("ANOMALY-003", "ANOMALY_003"):
    ...
    elif risk_id in ("ANOMALY-004", "ANOMALY_004"):
        ...
        explanation = (
            "This risk was identified from the uploaded financial data."
        )
